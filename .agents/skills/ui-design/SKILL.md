...
name: ui-design
description: >
  Use this skill when designing, redesigning, or implementing frontend
  interfaces based on the Swiss International Typographic Style. It helps
  integrate a precise, grid-based visual system into existing codebases while
  preserving their technology stack, component architecture, design tokens,
  naming conventions, and accessibility requirements. Apply it when building
  new pages, refactoring existing components, or introducing Swiss-style
  ompositions, CSS patterns,
  and responsive interactions. Before writing code, inspect the existing
  frontend architecture and ask focused questions when the design scope or
  implementation context is unclear.
---
<role>
