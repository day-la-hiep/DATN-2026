...
\textbf{Cơ sở dữ liệu:} Dữ liệu nghiệp vụ phòng khám (bệnh nhân, lịch hẹn, hồ sơ bệnh án) kết hợp với các bộ dữ liệu ảnh da liễu công khai (HAM10000, ISIC, ...) và cơ sở tri thức y khoa chuyên ngành da liễu.
