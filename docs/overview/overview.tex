...
\textbf{Tên đề tài:} Xây dựng hệ thống chatbot hỗ trợ chẩn đoán bệnh da liễu dựa trên kết hợp thị giác máy tính, đồ thị tri thức và truy xuất tăng cường (RAG)

\textbf{Lĩnh vực nghiên cứu:} Trí tuệ nhân tạo ứng dụng trong y tế, cụ thể là hỗ trợ chẩn đoán bệnh da liễu thông qua ảnh tổn thương da và mô tả triệu chứng bằng văn bản.

\textbf{Cơ sở dữ liệu:} Bộ dữ liệu HAM10000 gồm 10,015 ảnh nội soi da thuộc 7 lớp bệnh:
\begin{itemize}
...
\begin{itemize}
    \item Xây dựng một hệ thống thông minh có khả năng tiếp nhận ảnh tổn thương da và/hoặc mô tả triệu chứng từ người dùng, từ đó đưa ra chẩn đoán bệnh da liễu kèm giải thích chi tiết.
    \item Tích hợp ba phương pháp bổ trợ lẫn nhau:
    \begin{enumerate}
    ...
    \end{enumerate}
    \item Xây dựng hệ thống có khả năng \textbf{giải thích} kết quả chẩn đoán (Explainable AI), giúp người dùng hiểu rõ căn cứ mà hệ thống dựa vào để đưa ra nhận định.
    \item Tạo nền tảng có thể mở rộng từ 7 bệnh (HAM10000) lên hàng trăm bệnh da liễu trong tương lai.
    \item Làm cơ sở cho các nghiên cứu tiếp theo về tích hợp đa phương thức (Multi-modal Fusion) trong lĩnh vực chẩn đoán y tế tự động.
\end{itemize}
